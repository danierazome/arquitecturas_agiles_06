...
- **Crear Candidato:** `INSERT INTO Candidato (usuario, password, nombre, experiencia, telefono, email) VALUES ('candidato1', '1234', 'test testing', 'Experiencia del Candidato', '123456789', 'correo@valido1.com');` Recordar usar un correo real para validar el envío.
- **Crear CandidatoN2:** `INSERT INTO Candidato (usuario, password, nombre, experiencia, telefono, email) VALUES ('candidato2', '7890', 'test testing2', 'Experiencia del Candidato2', '1234567890', 'correo@valido2.com');` Recordar usar un correo real para validar el envío.
